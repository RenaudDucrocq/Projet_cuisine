...
def render_full_text(image_file, fileout):
    """Renders the full text of the document given an image.

    Args:
        image_file: path to the input image.
        fileout: path to the output text file.
    """
    client = vision.ImageAnnotatorClient()
...
if __name__ == "__main__":
    #render_doc_text("../images/IMG_3061.jpg", "outputs/output.jpg")
    render_full_text("../images/IMG_3061.jpg", "outputs/output.txt")